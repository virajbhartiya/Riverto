...
class QueueAudioApp extends StatefulWidget {
  final List<QueueModel> songs;
  final int index;
  QueueAudioApp(this.songs, this.index);
  @override
  _QueueAudioAppState createState() => _QueueAudioAppState();
}

@override
class _QueueAudioAppState extends State<QueueAudioApp> {
  Duration duration;
  Duration position;
